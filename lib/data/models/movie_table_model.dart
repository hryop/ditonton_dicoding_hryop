...
class MovieTableModel extends Equatable {
  ...
  factory MovieTableModel.fromEntity(MovieDetail movie) =>
      MovieTableModel(
          id: movie.id,
          title: movie.title,
  ...
  factory MovieTableModel.fromTvEntity(TvSeriesDetail tvSeriesDetail) =>
      MovieTableModel(
  ...
  factory MovieTableModel.fromDTO(MovieModel movie) =>
      MovieTableModel(
          id: movie.id,
          title: movie.title,
          posterPath: movie.posterPath,
  ...
  factory MovieTableModel.fromTvDTO(TvSeriesModel tvSeriesModel) =>
      MovieTableModel(
          id: tvSeriesModel.id,
