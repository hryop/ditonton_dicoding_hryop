...
void main() {
  ...
  //         .thenAnswer((_) async => []);
  //     // act
  //     final call = mockLocalDataSource.getCachedNowPlayingMovies();
  //     // assert
  ...
  group('save watchlist', () {
    test('should return success message when saving successful', () async {
      // arrange
      when(
        mockWatchlistLocalDataSource.insertWatchlist(testMovieTable),
  ...
  group('remove watchlist', () {
    test('should return success message when remove successful', () async {
      // arrange
      when(
        mockWatchlistLocalDataSource.removeWatchlist(testMovieTable),
